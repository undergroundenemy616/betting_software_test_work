...
В связи с тем, что хранимые тела запросов могут быть достаточно "жирными", выбор пал на MongoDB в качестве базы данных. База шардируется двумя нодами, каждая нода имеет по 3 реплики.
